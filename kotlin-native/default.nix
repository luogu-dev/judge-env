...
# Which means, they still need other libraries from system, such as libtinfo.so.5.
# OK, although ncurses has upgraded to 6.x, I can still install ncurses5 for you (check propagatedBuildInputs)
# ncurses needs glibc? No problem, I give it to you. But why does it throw the error below?
